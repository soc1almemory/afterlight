...
const copy = {
  ru: {
    ...
    text: {
      ...
      botConnected: 'Afterlight подключён. Теперь можно управлять задачами прямо из Telegram.\n\nAfterlight is connected. You can now manage tasks directly from Telegram.', cancel: 'Действие отменено.', categoryCreated: (title) => `Категория создана: ${title}`, categoryEmpty: 'Напишите название категории.', categoryExists: (title) => `Категория уже есть: ${title}`,
