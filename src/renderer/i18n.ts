...
const translations = {
  ru: {
    ...
    tomorrow: 'Завтра',
    updateDownloadingBody: 'Можно продолжать работать. Мы сообщим, когда все будет готово.',
    updateDownloadingTitle: 'Скачиваем обновление',
    updateNewVersion: 'новая версия',
    updateReadyBody: '{version} готова к установке.',
  ...
  en: {
    ...
    tomorrow: 'Tomorrow',
    updateDownloadingBody: 'You can keep working. We will let you know when it is ready.',
    updateDownloadingTitle: 'Downloading update',
    updateNewVersion: 'new version',
    updateReadyBody: '{version} is ready to install.',
